  ...
  return (
    <div className="w-full pb-24 pt-16 relative">
      <div className="container mx-auto max-w-6xl px-4">
        {/* Seccion de "Program Gallery" y "AI-Generated Programs" */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {
            USER_PROGRAMS.map((program) => (
              ...
              >
                {/* Encabezado de la tarjeta con info del user */}
                ...
                {/* Desde la imagen circular hasta el texto "v3.5" */}
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <CardTitle className="text-xl text-foreground">
                        {program.first_name} <span className="text-primary">{program.last_name}</span>
                      </CardTitle>
                ...
                <CardContent className="px-5">
                  {/* Detalles del programa: Desde (de la 1° tarjeta) "Beginner Weight Loss Program" hasta "Protection systems enabled" */}
                  ...
                  {/* Descripcion del programa: Texto (de la 1° tarjeta) "This program focuses on building" */}
                ...
                {/* Boton "View Program Details" */}
                <CardFooter className="px-5 py-4 border-t border-border">
                  <Link href={`/programs/${program.id}`} className="w-full">
                    <Button className="w-full bg-primary text-primary-foreground hover:bg-primary/90">
                      View Program Details <ChevronRight className="ml-2 h-4 w-4" />
                    </Button>
                  </Link>
                </CardFooter>
              </Card>
        ...
        {/* Seccion CTA (call-to-action) con el boton "Generate Your Program" */}
