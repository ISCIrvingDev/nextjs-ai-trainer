    ...
    <section className="relative z-10 pt-12 pb-32 flex-grow container mx-auto px-4">
...

      {
        allPlans && allPlans?.length > 0 ?
                  ...
                  <div className="relative backdrop-blur-sm border border-border rounded-lg p-6">
                    ...
                    <Tabs defaultValue="workout" className="w-full">
                      <TabsList className="mb-6 w-full grid grid-cols-2 bg-cyber-terminal-bg border">
                        ...
                        >
                          <DumbbellIcon className="mr-2 size-4" /> Workout Plan
                        </TabsTrigger>
                        ...
                        <TabsTrigger
                          ...
                          className="data-[state=active]:bg-primary/20 data-[state=active]:text-primary"
                        >
                          <AppleIcon className="mr-2 h-4 w-4" /> Diet Plan
                        </TabsTrigger>
                      </TabsList>
          ...
          (
            // Seccion: No plan (Se muestra cuando no hay planes elavorados por el usuario)
            <NoFitnessPlan />
          )
      }
    </section>
